...
const validateTriangleSides = ({
  ...
  const errorMessages = {
    sideAandBError: `The sum of Side A and Side B cannot be less than Side C (${sideA_num} + ${sideB_num} < ${sideC_num})`,
    sideAandCError: `The sum of Side A and Side C cannot be less than Side B (${sideA_num} + ${sideC_num} < ${sideB_num})`,
    sideBandCError: `The sum of Side B and Side C cannot be less than Side A (${sideB_num} + ${sideC_num} < ${sideA_num})`,
  };
